...
{
    public class EocWorkflowManager : IWorkflowManager
    {// The maximum recursion depth is used to limit the number of Workflow (of any type) that a given
        ...
        private static Dictionary<string, CancellationTokenSource> RunningWorkflowCancellationTokens = new Dictionary<string, CancellationTokenSource>();
        ...
        public EocWorkflowManager
        (
            IActivityLibrary activityLibrary,
            IWorkflowFaultHandler workflowEventHandler,
            ...
            ILogger<EocWorkflowManager> logger,
        ...
        )
        {
            ...
            _workflowFaultHandler = workflowEventHandler;
        ...
        public Task<ActivityContext> CreateActivityExecutionContextAsync(ActivityRecord activityRecord, JObject properties)
        {
            ...
            {
                ActivityRecord = activityRecord, Activity = activity
            };
        ...
        public async Task<WorkflowExecutionContext> StartWorkflowAsync(WorkflowType workflowType, ActivityRecord startActivity = null, IDictionary<string, object> input = null, string correlationId = null)
        {
            ...
            RunningWorkflowCancellationTokens.Add(workflow.WorkflowId, source);
